...
const PlaceholderCard = () => {
    return (
        <Card className="m-5">
            <Card.Img variant="top" src='https://img.freepik.com/free-vector/scene-with-house-trees-garden_1308-104648.jpg' style={{ height: '140px', overflow: 'hidden', padding: '8px' }} />
